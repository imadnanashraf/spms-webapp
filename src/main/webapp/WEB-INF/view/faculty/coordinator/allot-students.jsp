            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-3  mt-5">
                        ...
                        <!-- FILTER ROW-->
                        <form:form action="${pageContext.request.contextPath}/faculty/coordinator/addProcessStudents" modelAttribute="allotStudentModel" method="get">
                            <div class="row mt-2 mb-2">
                                ...
                                <div class="col-sm-2">
                                    <div class="mx-auto">
                                        <button type="submit" class="btn btn-primary">Allot <i class="fas fa-hand-point-up"></i></button>
                                    </div>                                           
                                </div>
                                ...
                                <div class="card shadow mb-4 ">
                                    ...
                                    <div class="card-body ">
                                        <div style="overflow-x:auto;">
											...
											<c:forEach var="mentorData" items="${mentorData}">
                                                <h6>
                                                    <tr >
                                                        <td>${mentorData.batch}</td>
                                                        <td>${mentorData.semester}</td>
                                                        
                                                        <c:if test="${mentorData.learnerType == 'FAST'}">
	                                                       <td style="background-color:#4BB543;">${mentorData.learnerType}</td>
	                                                    </c:if>
	                                                    
	                                                    <c:if test="${mentorData.learnerType == 'SLOW'}">
	                                                       <td style="background-color:#D0342C;">${mentorData.learnerType}</td>
	                                                    </c:if>
	                                                    
	                                      			    <td>
                                                            <div class="text-center">
                                                            <a href="${pageContext.request.contextPath}/resources/profile/${mentorData.faculty.profilePic}">
                                                                <img src="${pageContext.request.contextPath}/resources/profile/${mentorData.faculty.profilePic}" class="img-thumbnail shadow-lg " alt="..." width="100px" height="100px" >
                                                            </a>
                                                            </div>

                                                        </td>
                                                        <td>${mentorData.faculty.email}</td>
                                                    </tr>
                                                </h6>
                                             </c:forEach>
                                            </table>
