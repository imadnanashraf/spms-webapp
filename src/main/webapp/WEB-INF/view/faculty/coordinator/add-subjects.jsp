            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-3  mt-5">
                        ...
                        <!-- ADD ROW-->
                        <form:form action="${pageContext.request.contextPath}/faculty/coordinator/addSubject" modelAttribute="addSubjectModel" method="get">
                            <div class="row mt-2 mb-2">
                                ...
                                <div class="col-sm-9">
                                    ...
                                    <div class="row">
                                        <div class="col-sm mt-2">
                                            <div>
                                                <form:input path="subject" type="text" class="form-control" placeholder="Subject Name" style="color: black;"/>
                                            </div>
                                            <div >
                                               <form:errors path="subject" class="form-text" style="color:red;"/>
                                            </div>
                                        ...
                                        <div class="col-sm mt-2">
                                            ...
                                            <div>
                                        	   <form:input path="email" type="text" class="form-control" placeholder="Faculty Email Id" style="color: black;"/>
                                    		</div>
                                ...
                                <div class="col-sm mt-2">
                                    <div class="mx-auto">
                                        <button type="submit" class="btn btn-primary">Add <i class="fas fa-file"></i></button>
                                    </div>                                           
                                </div>
                        ...
                        <!-- LIST ROW-->
                        <form:form action="${pageContext.request.contextPath}/faculty/coordinator/listSubjects" modelAttribute="listSubjectModel" method="get">
                            <div class="row mt-2 mb-2">
                                ...
                                <div class="card shadow mb-4 ">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary ">
                                            SUBJECT LIST: ${currentFaculty.dept}
                                        </h6>
                                    </div>
                                    <div class="card-body ">
                                        <div style="overflow-x:auto;">
											...
											<c:forEach var="subject" items="${subjectsList}">
                                                <c:url var="delete" value="/faculty/coordinator/deleteSubject">
                                                	<c:param name="subjectId" value="${subject.subjectId}"></c:param>
                                                </c:url>
                                                <h6>
                                                    <tr >
                                                        ...
                                                        <td>${subject.facultyEmail}</td>
                                                        <td>
                                                            <a href="${pageContext.request.contextPath}/resources/profile/${subject.profilePic}">
                                                                <img src="${pageContext.request.contextPath}/resources/profile/${subject.profilePic}" class="img-thumbnail shadow-lg" alt="..." width="100px" height="100px">
                                                            </a>
                                                        </td>
                                                        <td>${subject.facultyName}</td>
                                                        <td>${subject.facultyDept}</td>
                                                        
                                                        <td> 
                                                            <a href="${delete}" onclick="if(!(confirm('Are you Sure?'))) return false">Delete Subject</a>
                                                        </td>
                                                    </tr>
                                                </h6>
                                             </c:forEach>
