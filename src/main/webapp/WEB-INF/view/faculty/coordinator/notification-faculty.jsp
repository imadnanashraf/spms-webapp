            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-3  mt-5">
                        ...
                        <!-- NOTIFICATION ROW-->
                        <form:form action="${pageContext.request.contextPath}/faculty/coordinator/postNotification" modelAttribute="pushNotification" method="get">
                            ...
                            <div class="row mt-2 mb-2">
                                ...
                                <div class="col-sm-5 mx-auto">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <form:textarea path="notification" class="form-control" aria-label="With textarea" placeholder="Notificaton" maxlength="580" ></form:textarea>

                                    </div>
                                    
                                    <div>
                                         
                                        <form:errors path="notification" class="form-text" style="color:red;"/>
                                     
                                     </div>

                                    
                                        <div class="mx-auto mt-2">
                                            <button type="submit" class="btn btn-primary">Post <i class="fas fa-file"></i></button>
                                        </div>                                           
                                ...
                                <div class="card shadow mb-4 ">
                                    <div class="card-header py-3">
                                        <h6 class="m-0 font-weight-bold text-primary ">
                                            NOTIFICATIONS: ${currentFaculty.dept}
                                        </h6>
                                    </div>
                                    <div  class="card-body ">
                                              ...
                                              <c:forEach var="notification" items="${notificationList}">
                                                ...
                                                <h6>
                                                    <tr>
                                                        ...
                                                        <td >
                                                            <div class="row ">
                                                                <div class="col" style="height:70px ;width: 600px; overflow-x: hidden; ">
