                ...
                <div class="container-fluid">
                    ...
                    <!--form area-->
                        ...
                        <div class="row">
                            ...
                            <form:form action="${pageContext.request.contextPath}/faculty/imageUpdating" enctype="multipart/form-data" method="post">
                                    ...
                                    <div class="card-body">
                                        <div class="row pt-3">
                                            ...
                                            <div class="col-6 mx-auto">
                                                <a href="${pageContext.request.contextPath}/resources/profile/${currentFaculty.profilePic}">
                                                    <img src="${pageContext.request.contextPath}/resources/profile/${currentFaculty.profilePic}" class="img-thumbnail rounded-circle shadow-lg" alt="..." width="200px" height="200px">
                                                </a>
                                            </div>
                                            <div class="mb-3 mt-4">
                            ...
                            <div class="col-xl-8 col-lg-7">
							 ...
							 <form:form action="${pageContext.request.contextPath}/faculty/profileUpdating" modelAttribute="profileModel" method="GET">
                                <div class="card shadow mb-4 ">
                                    <div class="card-header py-3">
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text" id="disabledTextInput" class="form-control" placeholder="${currentFaculty.email}"/>
                                                </fieldset>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-6 ">
                                                        ...
                                                        <fieldset disabled>
                                                            ...
                                                            <input type="text" id="disabledTextInput" class="form-control" placeholder="${currentFaculty.dept}" />
                                                        </fieldset>
