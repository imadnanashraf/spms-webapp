            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="mb-3  mt-5">
                            ...
                            <!-- NOTIFICATION ROW-->
                        <form action="${pageContext.request.contextPath}/faculty/mentor/sendMessage" method="Post">
                            ...
                            <div class="row mt-2 mb-2">
                                ...
                                <div class="col-sm-5 mx-auto">
                                    <div>
                                        ...
                                        <input class="form-control" type="text" value="To: ${toEmail}" aria-label="Disabled input example" disabled readonly>
                            ...
                            <div class="row mt-3 mb-2">
                                ...
                                <div class="col-sm-5 mx-auto">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <textarea name="message" class="form-control" aria-label="With textarea" maxlength="580" placeholder="Message"></textarea>

                                    </div>

                                    
                                        <div class="mx-auto mt-2">
                                            <button type="submit" class="btn btn-primary">Send <i class="fas fa-arrow-circle-right"></i></button>
                                        </div>                                           
