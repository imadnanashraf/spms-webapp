                            ...
                            <div class="col-sm-12 p-1 mx-auto">
                                <div class="card shadow mb-4 ">
                                    <div class="card-header py-3">
                                        <h6 class="mt-1 font-weight-bold text-primary">
                                            NAME: ${studentName} | CONTACT: ${studentContact}
                                        </h6>
                                        <h6 class="mt-1 font-weight-bold text-primary">
                                            FATHER'S NAME: ${studentFather} | GUARDIAN CONTACT NO: ${studentGuardianContact}
                                        </h6>
                                    </div>
                                    <div class="card-body ">
                                                    ...
                                                    <div class="col-sm-3">
													   ...
													   <div class="collapse" id="collapseExample">
														  ...
														  <c:forEach var="subjects" items="${subjects}">
														  	...
														  	<c:url var="subSelected" value="/faculty/assessStudentSubSelected">
														  		<c:param name="semester" value="${semester}"></c:param>
														  		<c:param name="email" value="${email}"></c:param>
														  		<c:param name="subject" value="${subjects.subjectName}"></c:param>
														  		<c:param name="searchType" value="${searchType}"></c:param>
														  	</c:url>
														  
														  	
														  	<div class="card card-body">
														  		<a class="btn btn-primary" href="${subSelected}">${subjects.subjectName}</a>
														  	</div>
