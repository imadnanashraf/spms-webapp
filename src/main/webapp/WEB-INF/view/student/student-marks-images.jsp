                        ...
                        <div class="row ">
                            ...
                            <div class="col-sm-10 p-1 mx-auto">
                                <div class="card shadow mb-4 ">
                                    <div class="card-body ">
                                        <form action="${pageContext.request.contextPath}/student/marksPicsUploading" enctype="multipart/form-data" method="post">
                                            <input type="hidden" name="semester" value="${semester}">
                                            <input type="hidden" name="internalPercent" value="${internalPercent}">
                                            <input type="hidden" name="previousPercent" value="${previousPercent}">
                                            
                                            <div class="row">
                                				<div class="col-sm-4 mx-auto">
                                    				<div class="mb-3 mt-4">
                                        				<label for="formFile" class="form-label">Mid Sem Result Picture(.jpg)</label>
                                        				<input name="internalPic" class="form-control" type="file" accept="image/jpeg, image/jpg"  id="formFile"/>
                                        				<span class="form-text" style="color:red;"/>${internalMessage}</span>
                                    				</div>
                                				</div>
                                				
                                				<div class="col-sm-4 mx-auto">
                                   					<div class="mb-3 mt-4">
                                        				<label for="formFile" class="form-label">Previous Year Result Picture(.jpg)</label>
                                        				<input name="previousPic" class="form-control" type="file" accept="image/jpeg, image/jpg" id="formFile"/>
                                        				<span class="form-text" style="color:red;"/>${previousMessage}</span>
                                    				</div>
                                				</div>
                            				</div>
