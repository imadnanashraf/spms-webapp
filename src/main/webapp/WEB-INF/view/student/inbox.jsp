    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-3 mt-2">
                                            ...
                                            <div>
                                                ...
                                                <a class="btn btn-primary" href="${pageContext.request.contextPath}/student/outbox" role="button">
                                                    <span>Sent</span> 
				...
				<c:forEach var="studentInbox" items="${studentInbox}">
					
					<c:set var="count" value="${count+1}"></c:set>
					<c:url var="write" value="/student/writeMessage">
						<c:param name="toEmail" value="${studentInbox.fromEmail}"></c:param>                  
					</c:url>
                                    ...
                                    <div data-toggle="collapse" href="#collapseExample${count}" role="button" aria-expanded="false" aria-controls="collapseExample">
                                        <h4>
                                           <div class="row align-items-center">
                                               <div class="col">From: ${studentInbox.fromEmail}</div>
                                           </div>
                                       </h4>
                                    </div>
