...
public class CustomStudentSuccessHandler implements AuthenticationSuccessHandler {
	...
	public void onAuthenticationSuccess(HttpServletRequest request, HttpServletResponse response,
		...
		//		session.setAttribute("loggedStudent", theStudent);
		...
		// NOT NEEDED AS INFO CAN BE ACCCESSED BY USING SECURITYCONTEXTHOLDER
				...
				spmsService.deleteAllStudentTokens(theStudent);
		
		response.sendRedirect(request.getContextPath()+"/student/studentPage");
